...
public class CustomFormatDialog extends Dialog {
    ...
    public CustomFormatDialog(@NonNull Context context, int currentType) {
        super(context);
        this.context = context;
        this.currentType = currentType;
    }

    public CustomFormatDialog(@NonNull Context context, @StyleRes int themeResId, int currentType) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_format_fee_info_config);
